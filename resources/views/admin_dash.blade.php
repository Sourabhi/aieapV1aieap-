      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#visitors" aria-controls="visitors" role="tab" data-toggle="tab"><b>Visitor's Queries</b></a></li>
          </ul>
          ...
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="days">
              <div class="table-responsive">
               ...
               <a href="{{url('create/day/')}}">Create Day</a>
            </div>
              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  @foreach ($users as $user)
                    <tr class="active">
                    <td><a href="{{url('user/'. $user->id)}}">{{ $user->id}}</td>
                    <td>{{ $user->name}}</td>
                    <td>{{ $user->email}}</td>
                    <td>{{ $user->password}}</td>
